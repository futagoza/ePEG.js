 ...
 * ==============
 *
 * This grammar was the same as the one in PEG.js, but deviated after 18 June 2016.
 *
 * Changes include:
 *
 *  - Include statements
 ...
 *  - Template rules
 *
 * Everything else that is not related to these new features has been left alone so
 * that changes in the official PEG.js grammar can easily be imported.
 *
 */
